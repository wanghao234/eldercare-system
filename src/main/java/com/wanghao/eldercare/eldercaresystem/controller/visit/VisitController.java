package com.wanghao.eldercare.eldercaresystem.controller.visit;
...
public class VisitController {
    ...
    @PreAuthorize("hasAuthority(T(com.wanghao.eldercare.eldercaresystem.common.security.Role).ROLE_FAMILY)")
