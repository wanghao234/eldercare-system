...
public class MedicationPlanListResponse {
    private List<MedicationPlanDTO> content;
    private long totalElements;
    private int page;
    private int size;

    public List<MedicationPlanDTO> getContent() {
        return content;
    }

    public void setContent(List<MedicationPlanDTO> content) {
